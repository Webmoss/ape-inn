  ...
  <div id="app">
    <div class="uniswap-container">
      <uniswap-vue
        ...
        :uniswap-dapp-shared-logic-context="uniswapDappSharedLogicContext"
      />
    </div>
...
<script lang="ts" setup>
  ...
  const uniswapDappSharedLogicContext = ref<any>(undefined);
  const isShowUniswap = ref<boolean>(false);

  function onSwitch() {
    isShowUniswap.value = !isShowUniswap.value;
  }
